/**
 * Siradig.js - Lógica para la herramienta de Siradig
 */

const TOOL_NAME = 'siradig';
let selectedFiles = [];
...
function handleProgress(status) {
    ...
    const message = status.status || 'Procesando...';
...
async function handleDownload() {
    ...
    try {
        ...
        downloadBlob(blob, 'siradig_resultado.zip');
...
async function handleDownloadLog() {
    ...
    try {
        ...
        downloadBlob(blob, 'siradig_log.txt');
